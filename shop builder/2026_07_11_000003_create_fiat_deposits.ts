...
export default class extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.decimal('exchange_rate', 24, 8).nullable()      // NGN per 1 unit of target stablecoin, locked at conversion time
      table.decimal('converted_amount', 24, 8).nullable()   // stablecoin amount actually credited
